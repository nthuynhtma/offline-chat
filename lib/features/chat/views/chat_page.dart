    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Attached files bar
          _AttachedFilesBar(sessionId: widget.sessionId),
...
/// Nằm giữa _ChatBody và ChatInputBar.
class _AttachedFilesBar extends StatefulWidget {
  final String sessionId;

  const _AttachedFilesBar({required this.sessionId});

  @override
  State<_AttachedFilesBar> createState() => _AttachedFilesBarState();
}

class _AttachedFilesBarState extends State<_AttachedFilesBar> {
  @override
  void initState() {
    super.initState();
          ...
          children: [
            ...
            Container(
              ...
              child: Wrap(
                spacing: 6,
                runSpacing: 4,
                children: files.map((file) => _FileChip(
                  file: file,
                  onRemove: () {
